  ...
  return (
    <>
      ...
      <div className="container w-screen h-screen flex flex-wrap items-start px-[1rem] justify-start">
        ...
        <div className="h-full w-full flex items-start md:pt-[5rem] justify-start md:w-3/6">
          {book !== null && (
            <div className="text-center md:text-left flex justify-start flex-col h-full py-[3rem] px-[2rem]">
              <h1 className="text-3xl font-bold text-black my-2">{book.name}</h1>
              <h3 className="text-1xl font-bold text-black my-2">{book.author}</h3>
              <h3 className="text-sm font-bold text-black italic my-2">
                Categoría: {book.category}
              </h3>
              <div className="md:h-[19rem] overflow-auto my-3">
